...
const options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "API for generating personalized content feeds, managing user interests, and tracking content metrics.",
      contact: {
        name: "Ahmad Esam",
    ...
    tags: [
      {
        name: "Authentication",
        description:
          "User authentication and authorization related operations.",
      },
      {
        name: "Feed",
        description:
